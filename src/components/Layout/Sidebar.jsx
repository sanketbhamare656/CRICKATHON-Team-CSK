  ...
  return (
    <aside className="sidebar glass-panel">
      <div className="sidebar-logo">
        <h1 className="logo-text text-neon-blue glow-blue">CS</h1>
      </div>
      ...
      <nav className="sidebar-nav">
        ...
        <a href="#" className="nav-item">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>
        </a>
        <a href="#" className="nav-item">
